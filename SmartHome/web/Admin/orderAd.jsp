<%-- 
    Document   : orderAd
    Created on : Jul 12, 2023, 11:10:19 AM
    Author     : FR
--%>
...
<html>
    ...
    <head>
        ...
        <title>Order Detail</title><link rel="stylesheet" href="../bootstrap/css/bootstrap.css"/>
        ...
        <div class="" id="home">
            ...
            <main class="page payment-page">
                <section class="payment-form dark">
                    <div class="container">
                        <div style="position: absolute; top: 27%; left: 23%; z-index: 5;">
