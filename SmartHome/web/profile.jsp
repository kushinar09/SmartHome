                                ...
                                <div class="col-md-6 d-flex align-items-stretch">
                                    <div class="contact-wrap w-100 p-md-5 p-4 py-5">
                                        ...
                                        <form action="home.jsp" method="post" id="contactForm" name="contactForm" class="contactForm">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 input-content">
                                                    <div class="form-group">
                                                        <p style="color: #919ba6; font-size: 1rem; margin: 0">Họ và tên: </p>
                                            ...
                                            <div class="col-md-12 input-content">
                                                <div class="form-group">
                                                    <p style="color: #919ba6; font-size: 1rem; margin: 0">Giới tính: </p>
                                            ...
                                            <div class="col-md-12 input-content">
                                                <div class="form-group">
                                                    <p style="color: #919ba6; font-size: 1rem; margin: 0">Ngày sinh: </p>
                                                    <input type="date" class="form-controlnew" name="dob" id="dob" value="${c.dob}" readonly>
                                                </div>
                                            </div>
                                            <div class="col-md-12 input-content">
                                                <div class="form-group">
                                                    <p style="color: #919ba6; font-size: 1rem; margin: 0">Số điện thoại: </p>
                                            ...
                                            <div class="col-md-12 input-content">
                                                ...
                                                <grammarly-extension data-grammarly-shadow-root="true"
                                                                     style="position: absolute; top: 0px; left: 0px; pointer-events: none;"
                                                                     class="dnXmp"></grammarly-extension>
                                                <p style="color: #919ba6; font-size: 1rem; margin: 0">Địa chỉ: </p>
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-12 input-content">
                                                <div class="form-group">
                                                    <input type="submit" value="Save" class="btn btn-primary" style="border-radius: 20px;">
                                                    <!--                                                    <button class="button-85" role="button">Save</button>-->
                                                    <button type="button" style="margin-right: 5px; color: #3c70f5; padding: 0; border: none; background: none;" onclick="show()">
                                                        Edit
